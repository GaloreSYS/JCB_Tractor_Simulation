...
//        senseglove.SetActive(true);
    ...
    void Update()
    {
        ...
        if (gearspeednumber.CheckEngine == true)
        {
            ...
            {
                if ((gearlevercontrol.gameObject.transform.localEulerAngles.y > 300) &&
                    ((gearlevercontrol.gameObject.transform.localEulerAngles.y < 360)))
                {
                    throttleAxis = 1.5f;
                    maxSpeed = 50;
            ...
            if (gearspeednumber.stampaccelerator == true)
            {
                ...
                else if (gearspeednumber.frontandbackdecider == 1)
