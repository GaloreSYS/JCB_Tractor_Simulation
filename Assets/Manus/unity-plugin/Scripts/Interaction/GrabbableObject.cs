...
namespace Manus.Interaction
{
	...
	{
		public UnityEvent objectGrabbed = new();
		public UnityEvent objectDropped = new();
		...
		public void OnGrabbedFixedUpdate(GrabbedObject p_Object)
		{
			...
			Quaternion t_Rot = Quaternion.Euler(transform.eulerAngles.x, transform.eulerAngles.y,0);
			...
			else
			{
				...
				transform.rotation = Quaternion.Euler(t_Rot.eulerAngles.x, t_Rot.eulerAngles.y, 0);
				transform.position =new Vector3(t_Pos.x,0, t_Pos.z);
			}
		}
